...
| Decoded fields, global / per packet / base / density allowance | 1,048,576 / 1,024 / 93,184 / one per 63 capture bytes |
| Field-child references, global / per packet / base / density allowance | 1,048,576 / 2,048 / 90,112 / one per 84 capture bytes |
