...
- Platform-neutral, bounded [Ethernet II, single-tag IEEE 802.1Q, ARP, IPv4, and IPv6 decoding](docs/protocol-decoding.md) with exact field-to-byte evidence, bounded option/extension traversal, fragment metadata, and structured recovery.
