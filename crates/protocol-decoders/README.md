...
bounded handoff. TCP, UDP, ICMP, and ICMPv6 decoding is not implemented yet.
Non-initial fragments never reach a transport-header decoder; first and atomic
fragments may continue. The decoder performs no fragment reassembly, IPsec
processing, or payload copying.
