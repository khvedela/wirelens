...
Recorded 2026-07-26T22:19:55.667Z from the production bundle in full Chromium 150.0.7871.184. The fixture generator created only deterministic synthetic traffic in temporary storage; its runtime manifest SHA-256 was `e1aa31de024f9016fc4d5d936f9609a7df37e37760a1c3c3cdefb439a60cea65`.
...
| Source base revision | `093f5de5e8f289c43bc053d317ffb792cf60b33b` |
| Source-tree SHA-256 | `4a0f496fcfc17fba77931eaaedaacf14437f976e6d13d5b4b911f6b129456ad8` |

## Quantitative supported-path result

| Measurement | Result | Gate | Status |
| --- | ---: | ---: | --- |
| Effective file-read + ingest + index throughput | 296.14 MiB/s | >=50 MiB/s | pass |
| Main-thread long tasks over 50 ms | 0 | 0 | pass |
| Main-thread heartbeat ticks during import | 204 | >0 | pass |
| Cancellation acknowledgement samples | 3.85, 6.64, 11.99, 6.00, 5.93, 4.38 ms | reading + parsing | pass |
| Cancellation acknowledgement median | 5.96 ms | <=200 ms | pass |
